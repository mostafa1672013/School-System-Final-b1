...
export const mockStudents: Student[] = [
  { id: 's1', nationalId: '30001010112345', name: 'يوسف أحمد إبراهيم', stage: 'kg', grade: 'KG1', className: 'KG1-أ', guardianName: 'أحمد إبراهيم محمود', guardianPhone: '01001234567', address: 'المعادي - القاهرة', enrollmentDate: '2024-09-01', status: 'active', totalFees: 15000, paidAmount: 15000 },
  { id: 's2', nationalId: '30002020223456', name: 'مريم خالد العتيبي', stage: 'kg', grade: 'KG2', className: 'KG2-ب', guardianName: 'خالد العتيبي سعد', guardianPhone: '01012345678', address: 'مدينة نصر - القاهرة', enrollmentDate: '2024-09-01', status: 'active', totalFees: 15000, paidAmount: 10000 },
  { id: 's3', nationalId: '30003030334567', name: 'عمر محمد الشريف', stage: 'primary', grade: 'الأول', className: '1/أ', guardianName: 'محمد الشريف حسن', guardianPhone: '01023456789', address: 'التجمع الخامس - القاهرة', enrollmentDate: '2024-09-01', status: 'active', busRouteId: 'r3', totalFees: 18000, paidAmount: 18000 },
  { id: 's4', nationalId: '30004040445678', name: 'فاطمة علي حسن', stage: 'primary', grade: 'الثاني', className: '2/ب', guardianName: 'علي حسن محمد', guardianPhone: '01034567890', address: 'حلوان - القاهرة', enrollmentDate: '2024-09-01', status: 'active', busRouteId: 'r1', totalFees: 18000, paidAmount: 12000 },
  { id: 's5', nationalId: '30005050556789', name: 'أحمد عبدالرحمن السيد', stage: 'primary', grade: 'الثالث', className: '3/أ', guardianName: 'عبدالرحمن السيد أحمد', guardianPhone: '01045678901', address: 'المهندسين - الجيزة', enrollmentDate: '2024-09-01', status: 'active', totalFees: 18000, paidAmount: 18000 },
  { id: 's6', nationalId: '30006060667890', name: 'نور الدين سعيد', stage: 'primary', grade: 'الرابع', className: '4/أ', guardianName: 'سعيد أحمد نور', guardianPhone: '01056789012', address: '6 أكتوبر - الجيزة', enrollmentDate: '2024-09-01', status: 'active', busRouteId: 'r4', totalFees: 18000, paidAmount: 9000 },
  { id: 's7', nationalId: '30007070778901', name: 'سارة محمود عبدالله', stage: 'primary', grade: 'الخامس', className: '5/ب', guardianName: 'محمود عبدالله فتحي', guardianPhone: '01067890123', address: 'الزيتون - القاهرة', enrollmentDate: '2024-09-01', status: 'active', busRouteId: 'r2', totalFees: 18000, paidAmount: 14000 },
  { id: 's8', nationalId: '30008080889012', name: 'خالد إبراهيم الفقي', stage: 'primary', grade: 'السادس', className: '6/أ', guardianName: 'إبراهيم الفقي عمر', guardianPhone: '01078901234', address: 'مصر الجديدة - القاهرة', enrollmentDate: '2024-09-01', status: 'active', totalFees: 18000, paidAmount: 18000 },
  { id: 's9', nationalId: '30009090990123', name: 'ليلى عمر أبو زيد', stage: 'preparatory', grade: 'الأول', className: '1 إعدادي/أ', guardianName: 'عمر أبو زيد سالم', guardianPhone: '01089012345', address: 'الدقي - الجيزة', enrollmentDate: '2024-09-01', status: 'active', busRouteId: 'r5', totalFees: 22000, paidAmount: 22000 },
  { id: 's10', nationalId: '30010101001234', name: 'محمد حسام الدين', stage: 'preparatory', grade: 'الثاني', className: '2 إعدادي/ب', guardianName: 'حسام الدين عبدالعزيز', guardianPhone: '01090123456', address: 'الشيخ زايد - الجيزة', enrollmentDate: '2024-09-01', status: 'active', busRouteId: 'r4', totalFees: 22000, paidAmount: 15000 },
  { id: 's11', nationalId: '30011111112345', name: 'هند طارق النجار', stage: 'preparatory', grade: 'الثالث', className: '3 إعدادي/أ', guardianName: 'طارق النجار محمد', guardianPhone: '01101234567', address: 'المعادي - القاهرة', enrollmentDate: '2024-09-01', status: 'active', totalFees: 22000, paidAmount: 22000 },
  { id: 's12', nationalId: '30012121223456', name: 'عبدالله رمضان خليل', stage: 'secondary', grade: 'الأول', className: '1 ثانوي/أ', guardianName: 'رمضان خليل عبدالله', guardianPhone: '01112345678', address: 'حلوان - القاهرة', enrollmentDate: '2024-09-01', status: 'active', busRouteId: 'r1', totalFees: 25000, paidAmount: 20000 },
  { id: 's13', nationalId: '30013131334567', name: 'ريم أشرف الصاوي', stage: 'secondary', grade: 'الثاني', className: '2 ثانوي/ب', guardianName: 'أشرف الصاوي حسن', guardianPhone: '01123456789', address: 'مدينة نصر - القاهرة', enrollmentDate: '2024-09-01', status: 'active', busRouteId: 'r2', totalFees: 25000, paidAmount: 25000 },
  { id: 's14', nationalId: '30014141445678', name: 'إبراهيم سمير عطية', stage: 'secondary', grade: 'الثالث', className: '3 ثانوي/أ', guardianName: 'سمير عطية إبراهيم', guardianPhone: '01134567890', address: 'التجمع الخامس - القاهرة', enrollmentDate: '2024-09-01', status: 'active', busRouteId: 'r3', totalFees: 25000, paidAmount: 18000 },
  { id: 's15', nationalId: '30015151556789', name: 'دينا مصطفى كامل', stage: 'kg', grade: 'KG1', className: 'KG1-ب', guardianName: 'مصطفى كامل أحمد', guardianPhone: '01145678901', address: 'المهندسين - الجيزة', enrollmentDate: '2024-09-01', status: 'active', totalFees: 15000, paidAmount: 7500 },
  { id: 's16', nationalId: '30016161667890', name: 'حسن عادل المنصوري', stage: 'primary', grade: 'الأول', className: '1/ب', guardianName: 'عادل المنصوري حسن', guardianPhone: '01156789012', address: '6 أكتوبر - الجيزة', enrollmentDate: '2024-09-01', status: 'active', busRouteId: 'r4', totalFees: 18000, paidAmount: 18000 },
  { id: 's17', nationalId: '30017171778901', name: 'ملك وائل البدري', stage: 'primary', grade: 'الثالث', className: '3/ب', guardianName: 'وائل البدري سعيد', guardianPhone: '01167890123', address: 'الزيتون - القاهرة', enrollmentDate: '2024-09-01', status: 'active', busRouteId: 'r2', totalFees: 18000, paidAmount: 6000 },
  { id: 's18', nationalId: '30018181889012', name: 'طارق جمال رشدي', stage: 'preparatory', grade: 'الأول', className: '1 إعدادي/ب', guardianName: 'جمال رشدي طارق', guardianPhone: '01178901234', address: 'مصر الجديدة - القاهرة', enrollmentDate: '2024-09-01', status: 'active', totalFees: 22000, paidAmount: 22000 },
  { id: 's19', nationalId: '30019191990123', name: 'ياسمين صلاح حمدي', stage: 'preparatory', grade: 'الثاني', className: '2 إعدادي/أ', guardianName: 'صلاح حمدي ياسر', guardianPhone: '01189012345', address: 'الدقي - الجيزة', enrollmentDate: '2024-09-01', status: 'active', busRouteId: 'r5', totalFees: 22000, paidAmount: 11000 },
  { id: 's20', nationalId: '30020202001234', name: 'كريم ناصر الغامدي', stage: 'secondary', grade: 'الأول', className: '1 ثانوي/ب', guardianName: 'ناصر الغامدي فهد', guardianPhone: '01190123456', address: 'الشيخ زايد - الجيزة', enrollmentDate: '2024-09-01', status: 'active', busRouteId: 'r4', totalFees: 25000, paidAmount: 25000 },
  { id: 's21', nationalId: '30021212112345', name: 'سلمى هشام زكي', stage: 'secondary', grade: 'الثاني', className: '2 ثانوي/أ', guardianName: 'هشام زكي محمود', guardianPhone: '01201234567', address: 'المعادي - القاهرة', enrollmentDate: '2024-09-01', status: 'active', totalFees: 25000, paidAmount: 19000 },
  { id: 's22', nationalId: '30022222223456', name: 'بلال أنور شعبان', stage: 'primary', grade: 'الرابع', className: '4/ب', guardianName: 'أنور شعبان محمد', guardianPhone: '01212345678', address: 'حلوان - القاهرة', enrollmentDate: '2024-09-01', status: 'active', busRouteId: 'r1', totalFees: 18000, paidAmount: 13500 },
  { id: 's23', nationalId: '30023232334567', name: 'جنى عبدالحميد فوزي', stage: 'kg', grade: 'KG2', className: 'KG2-أ', guardianName: 'عبدالحميد فوزي جمال', guardianPhone: '01223456789', address: 'مدينة نصر - القاهرة', enrollmentDate: '2024-09-01', status: 'active', totalFees: 15000, paidAmount: 15000 },
  { id: 's24', nationalId: '30024242445678', name: 'زياد وليد سالم', stage: 'primary', grade: 'الخامس', className: '5/أ', guardianName: 'وليد سالم أحمد', guardianPhone: '01234567890', address: 'التجمع الخامس - القاهرة', enrollmentDate: '2024-09-01', status: 'active', busRouteId: 'r3', totalFees: 18000, paidAmount: 9000 },
  { id: 's25', nationalId: '30025252556789', name: 'آية حسين الشافعي', stage: 'secondary', grade: 'الثالث', className: '3 ثانوي/ب', guardianName: 'حسين الشافعي عمر', guardianPhone: '01245678901', address: 'الدقي - الجيزة', enrollmentDate: '2024-09-01', status: 'active', totalFees: 25000, paidAmount: 25000 },
];
...
export const mockBusRoutes: BusRoute[] = [
  { id: 'r1', name: 'خط المعادي - حلوان', driverName: 'حسن محمد عبدالله', driverPhone: '01551234567', busNumber: 'ق م ن 1234', capacity: 40, monthlyFee: 500, annualFee: 5000, stops: ['المعادي الجديدة', 'ساقية مكي', 'دار السلام', 'حلوان البلد', 'عين حلوان'] },
  { id: 'r2', name: 'خط مدينة نصر - الزيتون', driverName: 'محمود سعيد أحمد', driverPhone: '01552345678', busNumber: 'ق م ن 5678', capacity: 35, monthlyFee: 450, annualFee: 4500, stops: ['عباس العقاد', 'مكرم عبيد', 'الحي السابع', 'الزيتون', 'حدائق الزيتون'] },
  { id: 'r3', name: 'خط التجمع الخامس', driverName: 'أحمد فتحي رمضان', driverPhone: '01553456789', busNumber: 'ق م ن 9012', capacity: 45, monthlyFee: 600, annualFee: 6000, stops: ['الرحاب', 'التجمع الأول', 'التجمع الثالث', 'التجمع الخامس', 'النرجس'] },
  { id: 'r4', name: 'خط 6 أكتوبر - الشيخ زايد', driverName: 'عبدالرحمن خالد', driverPhone: '01554567890', busNumber: 'ق م ن 3456', capacity: 40, monthlyFee: 550, annualFee: 5500, stops: ['الحي الأول', 'الحي السابع', 'الحي الثاني عشر', 'الشيخ زايد', 'بيفرلي هيلز'] },
  { id: 'r5', name: 'خط المهندسين - الدقي', driverName: 'سامي إبراهيم نور', driverPhone: '01555678901', busNumber: 'ق م ن 7890', capacity: 30, monthlyFee: 400, annualFee: 4000, stops: ['جامعة الدول العربية', 'شارع السودان', 'ميدان الدقي', 'المساحة', 'البحر الأعظم'] },
];

export const mockBusSubscriptions: BusSubscription[] = [
  { id: 'bs1', studentId: 's3', studentName: 'عمر محمد الشريف', routeId: 'r3', routeName: 'خط التجمع الخامس', type: 'annual', startDate: '2024-09-01', endDate: '2025-06-30', status: 'active' },
  { id: 'bs2', studentId: 's4', studentName: 'فاطمة علي حسن', routeId: 'r1', routeName: 'خط المعادي - حلوان', type: 'annual', startDate: '2024-09-01', endDate: '2025-06-30', status: 'active' },
  { id: 'bs3', studentId: 's6', studentName: 'نور الدين سعيد', routeId: 'r4', routeName: 'خط 6 أكتوبر - الشيخ زايد', type: 'annual', startDate: '2024-09-01', endDate: '2025-06-30', status: 'active' },
  { id: 'bs4', studentId: 's7', studentName: 'سارة محمود عبدالله', routeId: 'r2', routeName: 'خط مدينة نصر - الزيتون', type: 'monthly', startDate: '2025-01-01', endDate: '2025-01-31', status: 'active' },
  { id: 'bs5', studentId: 's9', studentName: 'ليلى عمر أبو زيد', routeId: 'r5', routeName: 'خط المهندسين - الدقي', type: 'annual', startDate: '2024-09-01', endDate: '2025-06-30', status: 'active' },
  { id: 'bs6', studentId: 's10', studentName: 'محمد حسام الدين', routeId: 'r4', routeName: 'خط 6 أكتوبر - الشيخ زايد', type: 'annual', startDate: '2024-09-01', endDate: '2025-06-30', status: 'active' },
  { id: 'bs7', studentId: 's12', studentName: 'عبدالله رمضان خليل', routeId: 'r1', routeName: 'خط المعادي - حلوان', type: 'annual', startDate: '2024-09-01', endDate: '2025-06-30', status: 'active' },
  { id: 'bs8', studentId: 's13', studentName: 'ريم أشرف الصاوي', routeId: 'r2', routeName: 'خط مدينة نصر - الزيتون', type: 'annual', startDate: '2024-09-01', endDate: '2025-06-30', status: 'active' },
  { id: 'bs9', studentId: 's14', studentName: 'إبراهيم سمير عطية', routeId: 'r3', routeName: 'خط التجمع الخامس', type: 'annual', startDate: '2024-09-01', endDate: '2025-06-30', status: 'active' },
  { id: 'bs10', studentId: 's16', studentName: 'حسن عادل المنصوري', routeId: 'r4', routeName: 'خط 6 أكتوبر - الشيخ زايد', type: 'annual', startDate: '2024-09-01', endDate: '2025-06-30', status: 'active' },
  { id: 'bs11', studentId: 's17', studentName: 'ملك وائل البدري', routeId: 'r2', routeName: 'خط مدينة نصر - الزيتون', type: 'annual', startDate: '2024-09-01', endDate: '2025-06-30', status: 'active' },
  { id: 'bs12', studentId: 's19', studentName: 'ياسمين صلاح حمدي', routeId: 'r5', routeName: 'خط المهندسين - الدقي', type: 'monthly', startDate: '2025-01-01', endDate: '2025-01-31', status: 'active' },
  { id: 'bs13', studentId: 's20', studentName: 'كريم ناصر الغامدي', routeId: 'r4', routeName: 'خط 6 أكتوبر - الشيخ زايد', type: 'annual', startDate: '2024-09-01', endDate: '2025-06-30', status: 'active' },
  { id: 'bs14', studentId: 's22', studentName: 'بلال أنور شعبان', routeId: 'r1', routeName: 'خط المعادي - حلوان', type: 'annual', startDate: '2024-09-01', endDate: '2025-06-30', status: 'active' },
  { id: 'bs15', studentId: 's24', studentName: 'زياد وليد سالم', routeId: 'r3', routeName: 'خط التجمع الخامس', type: 'annual', startDate: '2024-09-01', endDate: '2025-06-30', status: 'active' },
];

...
const pageTitles: Record<string, string> = {
  ...
  '/grade-item-lists': 'قوائم المستلزمات',
  '/delivery-orders': 'أوامر التسليم',
  '/inventory-distribution': 'توزيع المخزون',
  // HR/ZKTeco views from HEAD
  '/employees': 'شؤون العاملين',
  '/shifts': 'إدارة المناوبات',
  '/attendance': 'سجل الحضور والانصراف',
  '/hr-dashboard': 'لوحة تحكم الموظفين',
  '/admin-balances': 'تعديل أرصدة الإجازات',
};
